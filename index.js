...
getColorSchemeBtn.addEventListener("click", function () {
    ...
    fetch(`https://www.thecolorapi.com/scheme?hex=${colorPickerEl.value.slice(1)}&format=json&mode=${colorSchemeSelectorEl.value}&count=5`)
        .then(res => res.json())
        .then(data => {

            colorData.push(data)
            
            color1.style.backgroundColor = colorData[0].colors[0].hex.value
            color2.style.backgroundColor = colorData[0].colors[1].hex.value
            color3.style.backgroundColor = colorData[0].colors[2].hex.value
            color4.style.backgroundColor = colorData[0].colors[3].hex.value
            color5.style.backgroundColor = colorData[0].colors[4].hex.value

            footer1El.innerHTML = colorData[0].colors[0].hex.value
            footer2El.innerHTML = colorData[0].colors[1].hex.value
            footer3El.innerHTML = colorData[0].colors[2].hex.value
            footer4El.innerHTML = colorData[0].colors[3].hex.value
            footer5El.innerHTML = colorData[0].colors[4].hex.value
